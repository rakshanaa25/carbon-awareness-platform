    ...
    <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" aria-labelledby="concept-heading">
      <div className="text-center max-w-2xl mx-auto mb-12">
        ...
        <p className="mt-4 text-slate-600 dark:text-slate-400">
          A carbon footprint is the total volume of greenhouse gases—primarily carbon dioxide and methane—generated by our collective actions, measured in metric tons of equivalent $CO_2$.
        </p>
      </div>
