    ...
    <section className="relative overflow-hidden py-20 lg:py-32 bg-slate-50 dark:bg-slate-900 transition-colors" aria-labelledby="hero-heading">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h1 id="hero-heading" className="text-4xl sm:text-6xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-none">
            Carbon Footprint <span className="text-brand-600 dark:text-brand-500">Awareness Platform</span>
          </h1>
          ...
          <div className="mt-10 flex justify-center gap-4">
            <Button variant="primary" onClick={onStart} className="flex items-center gap-2 text-base px-6 py-3">
